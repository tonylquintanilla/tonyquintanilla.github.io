...
**Total Lines of Code (non-blank):** 15,710  
...
- `patch_L318_6_phone_tap_picking.py`
...
| `gallery_maintenance_run.py` | One pass over the gallery's generators and checkers. (839 lines) |
...
| `patch_L318_6_phone_tap_picking.py` | On a portrait phone, a tap reaches the marker instead of a shell's dots. (234 lines) |
