...
**Total Lines of Code (non-blank):** 15,151  
...
- `patch_L291_11_earth_mode5_round1_20260909.py`
...
| `gallery_maintenance_run.py` | One pass over the gallery's generators and checkers. (739 lines) |
...
| Module | Description |
|--------|-------------|
| `patch_L291_11_earth_mode5_round1_20260909.py` | - Earth exhibit, Mode 5 round 1 (gallery repo) (128 lines) |
